    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <p className={styles.subtitle}>Manage your restaurant account information and preferences</p>
        </div>
      </div>
      ...
      <div className={styles.content}>
          ...
          <div className={styles.profileForm}>
            ...
            <div className={styles.formGroup}>
              ...
              <div className={styles.accountType}>
                <span className={styles.restaurantBadge}>Restaurant</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.statsCard}>
          ...
          <div className={styles.statsGrid}>
            ...
            <div className={styles.statItem}>
              <div className={styles.statValue}>1,850</div>
              <div className={styles.statLabel}>People Helped</div>
            </div>
            <div className={styles.statItem}>
              <div className={styles.statValue}>642kg</div>
              <div className={styles.statLabel}>Food Donated</div>
            </div>
            <div className={styles.statItem}>
              <div className={styles.statValue}>95%</div>
              <div className={styles.statLabel}>Pickup Rate</div>
            </div>
          </div>
        </div>
      </div>
